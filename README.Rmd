...
[![MIT Licensed - Copyright 2016 EcoHealth Alliance](inst/figs/license-MIT-blue.svg)](https://badges.mit-license.org/)
...
Install **fasterize** fron CRAN.  It requires [**sf**](https::/cran.r-project.org/pakcage=sf), which requires GDAL (>= 2.0.0), GEOS (>= 3.3.0), PROJ.4 (>= 4.8.0) to be installed on your system.
